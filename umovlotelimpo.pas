...
type
  ...
  TfMovLoteLimpo = class(TForm)
    ...
    zqCliente: TZQuery;
    zqDoLoteLimpoIDLOTELIMPO: TZIntegerField;
    zqDoLoteLimpoNOMEDOLOTELIMPO: TZRawStringField;
    zqDoLoteLimpoSALDO: TZBCDField;
    ...
    zqMovLoteLimpoPESOENTRADA: TZBCDField;
    zqMovLoteLimpoPESOSAIDA: TZBCDField;
    ...
    ztSaldoLoteLimpoIDLOTELIMPO: TZIntegerField;
    ztSaldoLoteLimpoNOME: TZRawStringField;
    ztSaldoLoteLimpoSALDO: TZBCDField;
