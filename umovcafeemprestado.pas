...
type
  ...
  TfMovCafeEmprestado = class(TForm)
    ...
    zqMovCafeEmprestadoIDCLIENTE: TZIntegerField;
    zqMovCafeEmprestadoIDLOTELIMPO: TZIntegerField;
    zqMovCafeEmprestadoNOME: TZRawStringField;
    zqMovCafeEmprestadoPESODEVOLVER: TZBCDField;
    zqMovCafeEmprestadoPESOEMPRESTAR: TZBCDField;
    zqMovCafeEmprestadoSTATUS: TZRawStringField;
    zqNovoIDCafeEmprestadoID: TZIntegerField;
    zqNovoIDCafeEmprestado: TZQuery;
    zqNovoIDMovLoteLimpoID: TZIntegerField;
    zqParaLoteLimpo: TZQuery;
    zqParaLoteLimpoIDLOTELIMPO: TZIntegerField;
    ...
    ztCliente: TZTable;
    ztClienteIDCLIENTE: TZIntegerField;
    ztClienteSALDOCAFEEMPRESTADO: TZBCDField;
    ztLoteLimpo: TZTable;
    ztCafeEmprestado: TZTable;
    ztCafeEmprestadoDATA: TZDateField;
    ztCafeEmprestadoHISTORICO: TZRawStringField;
    ztCafeEmprestadoIDCAFEEMPRESTADO: TZIntegerField;
    ztCafeEmprestadoIDCLIENTE: TZIntegerField;
    ztCafeEmprestadoIDLOTELIMPO: TZIntegerField;
    ztCafeEmprestadoPESODEVOLVER: TZBCDField;
    ztCafeEmprestadoPESOEMPRESTAR: TZBCDField;
