...
type
  ...
  TfRomEntCoco = class(TForm)
    ...
    zqLoteCocoIDLOTECOCO: TZIntegerField;
    zqLoteCocoNOMELOTECOCO: TZRawStringField;
    zqLoteCocoSALDOCOCO: TZIntegerField;
    ...
    ztContaCorrenteIDACERTO: TZIntegerField;
    ztContaCorrenteIDCLIENTE: TZIntegerField;
    ztContaCorrenteIDCONTACORRENTE: TZIntegerField;
    ztContaCorrenteSAIDA: TZBCDField;
    ztContaCorrenteSTATUS: TZRawStringField;
    ztEstoqueDepositoCocoIDESTOQUEDEPOSITOCOCO: TZIntegerField;
    ztEstoqueDepositoCocoIDROMENTRADACOCO: TZIntegerField;
    ztEstoqueDepositoCocoPESOENTRADA: TZIntegerField;
    ztEstoqueDepositoCocoPESOSAIDA: TZIntegerField;
    ztEstoqueDepositoCocoSALDO: TZIntegerField;
    ...
    ztRomCompraCocoALIQUOTA: TZBCDField;
    ztRomCompraCocoDATA: TZDateField;
    ztRomCompraCocoHISTORICO: TZRawStringField;
    ztRomCompraCocoIDCONTACORRENTE: TZIntegerField;
    ztRomCompraCocoIDROMCOMPRACOCO: TZIntegerField;
    ztRomCompraCocoIDROMENTRADACOCO: TZIntegerField;
    ztRomCompraCocoPESOCOCO: TZIntegerField;
    ztRomCompraCocoPORCFUNDORURAL: TZIntegerField;
    ztRomCompraCocoSACOKG: TZRawStringField;
    ztRomCompraCocoSTATUS: TZRawStringField;
    ztRomCompraCocoVALOR: TZBCDField;
    ...
    ztRomEntradaCocoBEBERCOCO: TZIntegerField;
    ztRomEntradaCocoBEBERLIMPO: TZBCDField;
    ztRomEntradaCocoDATA: TZDateField;
    ztRomEntradaCocoDESCONTO1: TZIntegerField;
    ztRomEntradaCocoDESCONTO2: TZIntegerField;
    ztRomEntradaCocoIDCLIENTE: TZIntegerField;
    ztRomEntradaCocoIDLOTECOCO: TZIntegerField;
    ztRomEntradaCocoIDROMCOMPRACOCO: TZIntegerField;
    ztRomEntradaCocoIDROMENTRADACOCO: TZIntegerField;
    ztRomEntradaCocoIMPUREZA: TZIntegerField;
    ztRomEntradaCocoLEGENDA1: TZRawStringField;
    ztRomEntradaCocoLEGENDA2: TZRawStringField;
    ztRomEntradaCocoOBS: TZBlobField;
    ztRomEntradaCocoPESOBRUTO: TZIntegerField;
    ztRomEntradaCocoPESODEPOSITADO: TZIntegerField;
    ztRomEntradaCocoPESOJUTA: TZBCDField;
    ztRomEntradaCocoPESOPLASTICO: TZBCDField;
    ztRomEntradaCocoPESOPORCENTAGEM: TLongintField;
    ztRomEntradaCocoPORCENTAGEM: TZIntegerField;
    ztRomEntradaCocoQUANJUTA: TZIntegerField;
    ztRomEntradaCocoQUANPLASTICO: TZIntegerField;
    ztRomEntradaCocoRENDA: TZIntegerField;
    ...
    procedure SalvaMovLoteCoco(PesoCoco:integer);
...
begin
     ...
     PesoComprado:=strToInt(edtPesoComprado.Text);
     ztRomEntradaCocoCalcFields(ztRomEntradaCoco); //dispara o método oncalcFields
end;
...
begin
     ...
     BeberCoco:=ztRomEntradaCocoBeberCoco.Value;
...
procedure TfRomEntCoco.SalvaMovLoteCoco(PesoCoco:integer);
var temp:integer;
begin
