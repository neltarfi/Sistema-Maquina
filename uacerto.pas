...
type
  ...
  TfAcerto = class(TForm)
    ...
    zqAcertoSaldoSALDOACERTO: TZBCDField;
    zqAcertoSaldoSTATUS: TZRawStringField;
    zqCC: TZQuery;
    zqCCAcertoDATA: TZDateField;
    zqCCAcertoENTRADA: TZBCDField;
    zqCCAcertoHISTORICO: TZRawStringField;
    zqCCAcertoIDACERTO: TZIntegerField;
    zqCCAcertoIDCLIENTE: TZIntegerField;
    zqCCAcertoIDCONTACORRENTE: TZIntegerField;
    zqCCAcertoSAIDA: TZBCDField;
    zqCCAcertoSTATUS: TZRawStringField;
    zqCCDATA: TZDateField;
    zqCCENTRADA: TZBCDField;
    zqCCHISTORICO: TZRawStringField;
    zqCCIDACERTO: TZIntegerField;
    zqCCIDCLIENTE: TZIntegerField;
    zqCCIDCONTACORRENTE: TZIntegerField;
    zqCCSAIDA: TZBCDField;
    zqCCSTATUS: TZRawStringField;
    zqClienteBoxIDPRINCIPAL: TZIntegerField;
    zqClienteBoxRAZAO: TZRawStringField;
    zqClienteBoxSALDOCC: TZFMTBCDField;
    ...
    ztClienteSaldoIDCLIENTE: TZIntegerField;
    ztClienteSaldoSALDOCONTACORRENTE: TZBCDField;
