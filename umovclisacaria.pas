...
type
  ...
  TfMovCliSacaria = class(TForm)
    ...
    zqCliente: TZQuery;
    zqParaLoteSacariaIDLOTESACARIA: TZIntegerField;
    ...
    ztClienteSALDOSACARIAJUTA: TZIntegerField;
    ztClienteSALDOSACARIAPLASTICO: TZIntegerField;
    ztLoteSacaria: TZTable;
    ztCliente: TZTable;
    ztLoteSacariaIDLOTESACARIA: TZIntegerField;
    ztLoteSacariaNOME: TZRawStringField;
    ztLoteSacariaSALDO: TZIntegerField;
    ...
    ztMovLoteSacariaIDCLIENTE: TZIntegerField;
    ztMovLoteSacariaIDLOTESACARIA: TZIntegerField;
    ztMovLoteSacariaIDMOVLOTESACARIA: TZIntegerField;
    ztMovLoteSacariaQUANENTRADA: TZIntegerField;
    ztMovLoteSacariaQUANSAIDA: TZIntegerField;
